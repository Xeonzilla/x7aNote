...
继前面[部署Umami](/netlify-supabase-umami/)和[数据库迁移](/from-supabase-to-neon/)后，我又在使用Umami的过程中发现了新问题：怎么仪表盘的数据全是重复的呢？在GitHub一番搜索后，我找到了三个相同的案例[^1][^2][^3]，而且非常遗憾，开发者没有任何有效的答复，这个Bug目前悬而未决。
...
如果有一天，本站的域名不再是`xeonzilla.github.io`，那便是我的屈服之时。现在的我还有一丝倔强之心，能让我和各种免费服务再战三百回合。
