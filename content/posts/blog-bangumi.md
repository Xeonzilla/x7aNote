...
前端的设置上，我们需要到`layouts/shortcodes`路径下创建一个供Hugo使用的shortcode。使用CDN引入，并在HTML中使用组件，就能完成最基础的使用。
...
至少它在完成本职工作方面做得出色，基本的功能都实现了，甚至还有按页码跳转，算是勉强让我满意。
...
[^2]: [GeeKaven/BangumiTV: 一个基于Vercel Serverless Function的Bangumi.tv追番进度展示页面](https://github.com/GeeKaven/BangumiTV)
